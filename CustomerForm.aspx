<%@ Page Language="C#" AutoEventWireup="true" CodeFile="CustomerForm.aspx.cs"  MasterPageFile="~/MasterPage.master" Inherits="CustomerForm" %>
...
<asp:Content runat="server" ContentPlaceHolderID="ContentPlaceHolder1">
    ...
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header" style="margin-top: 15px">Customer Form</h2>
        </div>
    </div>
    <!--/.row-->
    <div class="row">
                ...
                <div class="panel panel-widget" style="background: #0A3AD8; color: white;">
                    <div class="row no-padding">
                        ...
                        <div class="col-sm-9 col-lg-7 widget-right">
                            <div class="large" style="font-size: 22px;">Suppiler Form</div>
    ...
    <script>
        $(document).ready(function () {
            $("#customerForm").attr("class", "active");
        });
        function Add() {
            ...
            if (company === "" || contact === "" || contacttit === "" || add === "" || code === "" || phone === "" || fax === "") {
                ...
                $.ajax({
                    ...
                    success: function (msg) {
                        alert(msg.d);
                        window.location = "CustomerForm.aspx";
                    }
